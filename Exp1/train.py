...
for epoch in range(epochs):
    ...
    for step, (train_input, indicator, train_output) in enumerate(train_loader):
        ...
        train_preds = model(train_input, indicator, ideal_atte_x)

        train_loss = custom_loss(train_preds, train_output)
...
np.save("LSTM train loss",train_loss_list)
np.save("LSTM test loss",test_loss_list)