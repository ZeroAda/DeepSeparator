...
# question: test is val?
print("Test input:",test_input.shape)
print("Test Output:",test_output.shape)


print("EOG Test input:",EOGEEG_test_input.shape)
print("EOG Test Output:",EOGEEG_test_output.shape)
print("EMG Test input:",EMGEEG_test_input.shape)
print("EMG Test Output:",EMGEEG_test_output.shape)
